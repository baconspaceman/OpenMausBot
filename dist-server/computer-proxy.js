...
const DISCORD_ACCOUNT_TOOLS = [
    ...
    },
    {
        ...
        description: "List channels in one Discord guild through the owner's account. Only channels the account can access should be treated as readable.",
    ...
    },
    {
        ...
        description: "Search readable messages in one Discord guild through the owner's account. Search is read-only and must be tied to the user's research question.",
        inputSchema: {
            type: "object",
